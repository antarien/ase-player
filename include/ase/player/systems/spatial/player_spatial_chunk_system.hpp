 ...
 *
 * @file        player_spatial_chunk_system.hpp
 * @brief       PlayerSpatialChunkSystem - Track player chunk presence
 ...
 * ARCHITECTURE:
 *
 *   PlayerStPosComponent ──> PlayerSpatialChunkSystem ──> PlayerStChkComponent
