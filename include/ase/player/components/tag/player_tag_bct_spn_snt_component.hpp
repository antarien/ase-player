 ...
 * =============================================================================
 *
 * @file        player_tag_bct_spn_snt_component.hpp
 * @brief       Tag marking spawn broadcast as sent
 * @description Added after spawn broadcast message is queued for replication
 *
 * -----------------------------------------------------------------------------
 * META
 * -----------------------------------------------------------------------------
