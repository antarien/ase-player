 ...
 * =============================================================================
 *
 * @file        player_tag_bct_sta_snt_component.hpp
 * @brief       Tag marking state broadcast as sent
 * @description Added after state broadcast message is queued for replication
 *
 * -----------------------------------------------------------------------------
 * META
 * -----------------------------------------------------------------------------
