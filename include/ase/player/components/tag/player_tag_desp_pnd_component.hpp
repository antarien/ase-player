 ...
 * =============================================================================
 *
 * @file        player_tag_desp_pnd_component.hpp
 * @brief       Tag marking player entity pending despawn
 * @description Added when despawn requested, entity destroyed at end of tick
 *
 * -----------------------------------------------------------------------------
 * META
 * -----------------------------------------------------------------------------
