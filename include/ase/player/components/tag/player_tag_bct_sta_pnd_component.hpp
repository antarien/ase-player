 ...
 * =============================================================================
 *
 * @file        player_tag_bct_sta_pnd_component.hpp
 * @brief       Tag marking entity for pending state broadcast
 * @description bct=broadcast, sta=state, pnd=pending
 *
 * -----------------------------------------------------------------------------
 * META
 * -----------------------------------------------------------------------------
