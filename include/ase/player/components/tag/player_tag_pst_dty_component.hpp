 ...
 * =============================================================================
 *
 * @file        player_tag_pst_dty_component.hpp
 * @brief       Tag marking player needs persistence
 * @description Set when player state changes, processed by PlayerPstSerSystem
 *
 * -----------------------------------------------------------------------------
 * META
 * -----------------------------------------------------------------------------
