 ...
 *
 * @file        player_buf_bct_spn_component.hpp
 * @brief       PlayerBufBctSpnComponent - Buffer for spawn broadcast serialization
 * @description Combines PlayerStIdComponent + PlayerStPosComponent for network
 *
 * @module      ase-player
 * @layer       3 (Module)
 * @category    buffer
